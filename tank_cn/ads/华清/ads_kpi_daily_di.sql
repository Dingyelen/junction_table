...
* @Last Modified time: 2024-10-23 17:02:18
*/
...
-- 【基础信息】
-- kpi
create table if not exists hive.tank_cn_w.ads_kpi_daily_di
(date date,
zone_id varchar,
channel varchar,
os varchar, 
...
delete from hive.tank_cn_w.ads_kpi_daily_di
where part_date >= $start_date
and part_date <= $end_date;

insert into hive.tank_cn_w.ads_kpi_daily_di
...
from hive.tank_cn_w.ads_kpi_daily_di
where part_date < $start_date
group by 1, 2, 3
), 
