create table if not exists hive.tank_cn_w.ads_top_daily_di
(date date,
role_id varchar,
zone_id varchar,
channel varchar,
...
delete from hive.tank_cn_w.ads_top_daily_di where part_date >= $start_date and part_date <= $end_date;

insert into hive.tank_cn_w.ads_top_daily_di
