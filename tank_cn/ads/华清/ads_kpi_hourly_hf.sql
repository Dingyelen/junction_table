...
-- 【基础信息】
-- kpi
drop table if exists hive.tank_cn_w.ads_kpi_hourly_hf;

create table if not exists hive.tank_cn_w.ads_kpi_hourly_hf
(date date,
hour timestamp,
zone_id varchar,
channel varchar,
...
insert into hive.tank_cn_w.ads_kpi_hourly_hf
...
from hive.tank_cn_w.dws_user_hourly_hi
