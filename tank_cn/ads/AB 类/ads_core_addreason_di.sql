###
create table if not exists hive.tank_cn_w.ads_core_addreason_di
(date date,
zone_id varchar,
channel varchar,
reason varchar,
...
delete from hive.tank_cn_w.ads_core_addreason_di
where part_date >= $start_date
and part_date <= $end_date;

insert into hive.tank_cn_w.ads_core_addreason_di
