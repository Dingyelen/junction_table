...
from hive.mushroom2_tw_r.dwd_merge_base_live a
...
select event_time, new_users, dau, retention1_users, retention1_users*1.000/yesterday_newusers as retention1_rate, 
pay_users, newpay_users, pay_users*1.000/dau as pay_rate, money*1.000/pay_users as arppu, money*1.000/dau as arpu, 
install_pay, install_money*1.000/install_pay as new_arppu, install_money*1.000/new_users as new_arpu, 
money, web_money
