...
-- 【基础信息】
-- kpi
create table if not exists hive.mushroom2_tw_w.ads_kpi_monthly_mi
(month date, 
zone_id varchar, 
channel varchar, 
os varchar, 
...
delete from hive.mushroom2_tw_w.ads_kpi_monthly_mi
where part_month >= $start_date
and part_month <= $end_date;

insert into hive.mushroom2_tw_w.ads_kpi_monthly_mi
