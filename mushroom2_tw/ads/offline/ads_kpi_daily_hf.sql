drop table if exists hive.mushroom2_tw_w.ads_kpi_daily_hf;

create table if not exists hive.mushroom2_tw_w.ads_kpi_daily_hf
(date date,
zone_id varchar,
channel varchar,
os varchar,
...
insert into hive.mushroom2_tw_w.ads_kpi_daily_hf
...
from user_daily a
left join hive.mushroom2_tw_w.dws_user_daily_derive_df b
