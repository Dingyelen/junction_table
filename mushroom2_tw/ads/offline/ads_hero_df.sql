drop table if exists hive.mushroom2_tw_w.ads_hero_df;

create table if not exists hive.mushroom2_tw_w.ads_hero_df(
role_id varchar, 
hero_level bigint, 
hero_power bigint, 
hero_star bigint, 
...
insert into hive.mushroom2_tw_w.ads_hero_df
(role_id, 
...
from hive.mushroom2_tw_w.dws_hero_snapshot_di
),
