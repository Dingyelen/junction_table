drop table if exists hive.mushroom2_tw_w.ads_act_daily_df;

create table if not exists hive.mushroom2_tw_w.ads_act_daily_df(
date date, 
part_date varchar, 
zone_id varchar, 
act_tag varchar, 
...
insert into hive.mushroom2_tw_w.ads_act_daily_df(
