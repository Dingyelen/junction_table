drop table if exists hive.mushroom2_tw_w.ads_battle_herostatus_df;

create table if not exists hive.mushroom2_tw_w.ads_battle_herostatus_df(
zone_id varchar,
vip_level bigint, 
...
insert into hive.mushroom2_tw_w.ads_battle_herostatus_df
...
from hive.mushroom2_tw_r.dwd_gserver_3v3battleinfo_live
...
left join hive.mushroom2_tw_w.dim_gserver_levelup_heroid b
