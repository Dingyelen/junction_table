drop table if exists hive.mushroom2_tw_w.ads_kpi_server_df;

create table if not exists hive.mushroom2_tw_w.ads_kpi_server_df(
zone_id varchar, 
open_date date, 
...
insert into hive.mushroom2_tw_w.ads_kpi_server_df(
zone_id, open_date, 
...
from hive.mushroom2_tw_w.dws_server_daily_df
