create table if not exists hive.mushroom2_tw_w.ads_user_retention_di
(date date, 
install_date date,
zone_id varchar,
channel varchar,
...
delete from hive.mushroom2_tw_w.ads_user_retention_di
where part_date >= $start_date
and part_date <= $end_date;

insert into hive.mushroom2_tw_w.ads_user_retention_di
