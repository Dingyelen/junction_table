create table if not exists hive.mushroom2_tw_w.ads_retention_daily_di
(date date,
...
delete from hive.mushroom2_tw_w.ads_retention_daily_di
where part_date >= date_format(date_add('day', -31, date($start_date)), '%Y-%m-%d')
and part_date <= $end_date;

insert into hive.mushroom2_tw_w.ads_retention_daily_di
