drop table if exists hive.mushroom2_tw_w.dws_token_monthly_mf;

create table if not exists hive.mushroom2_tw_w.dws_token_monthly_mf(
cal_month date,
...
insert into hive.mushroom2_tw_w.dws_token_monthly_mf(
