###
create table if not exists hive.mushroom2_tw_w.dws_user_daily_di(
date date, 
role_id varchar, 
device_id varchar, 
open_id varchar, 
...
delete from hive.mushroom2_tw_w.dws_user_daily_di 
where part_date >= $start_date
and part_date <= $end_date;

insert into  hive.mushroom2_tw_w.dws_user_daily_di
...
campaign_id, creative_id, adgroup_id 
from hive.mushroom2_tw_r.dwd_adjust_live
where part_date >= $start_date
and part_date <= $end_date
), 
...
1 as is_test
from hive.mushroom2_tw_w.dim_gserver_base_roleid
), 
