###
create table if not exists hive.mushroom2_tw_w.dws_core_snapshot_di(
date date, 
role_id varchar, 
...
delete from hive.mushroom2_tw_w.dws_core_snapshot_di
where part_date >= $start_date
and part_date <= $end_date;

insert into hive.mushroom2_tw_w.dws_core_snapshot_di(
date, role_id, 
