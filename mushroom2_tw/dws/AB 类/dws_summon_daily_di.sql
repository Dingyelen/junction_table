create table if not exists hive.mushroom2_tw_w.dws_summon_daily_di(
date date, 
start_date date, 
zone_id varchar, 
summon_free bigint, 
...
delete from hive.mushroom2_tw_w.dws_summon_daily_di
where summon_id in (
...
insert into  hive.mushroom2_tw_w.dws_summon_daily_di
