drop table if exists hive.mushroom2_tw_w.dws_server_daily_df;

create table if not exists hive.mushroom2_tw_w.dws_server_daily_df
(date date,
zone_id varchar,
open_date date, 
online_time bigint,
...
insert into hive.mushroom2_tw_w.dws_server_daily_df
...
left join hive.mushroom2_tw_w.dws_user_info_di z
