...
###
drop table if exists hive.mushroom2_tw_w.dws_adjust_cost_detail_df;
create table if not exists hive.mushroom2_tw_w.dws_adjust_cost_detail_df(
role_id varchar,
distinct_id varchar,
time timestamp(3),
event_name varchar,
...
insert into hive.mushroom2_tw_w.dws_adjust_cost_detail_df
...
from kudu.mushroom2_tw_r.dwd_adjust_cost_live
