###
create table if not exists hive.mushroom2_tw_w.dws_user_daily_derive_di(
date date, 
role_id varchar, 
login_days bigint, 
is_new bigint,
...
delete from hive.mushroom2_tw_w.dws_user_daily_derive_di where part_date >= $start_date and part_date <= $end_date;

insert into hive.mushroom2_tw_w.dws_user_daily_derive_di(
