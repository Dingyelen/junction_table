###
create table if not exists hive.mushroom2_tw_w.dws_user_hourly_hi
(date date,
hour timestamp,
role_id varchar,
zone_id varchar,
...
delete from hive.mushroom2_tw_w.dws_user_hourly_hi 
where part_date >= $start_date
and part_date <= $end_date;

insert into  hive.mushroom2_tw_w.dws_user_hourly_hi
