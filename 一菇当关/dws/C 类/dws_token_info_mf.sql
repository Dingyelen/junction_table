drop table if exists hive.mushroom_tw_w.dws_token_info_mf;

create table if not exists hive.mushroom_tw_w.dws_token_info_mf(
cal_month date,
role_id varchar, 
...
insert into hive.mushroom_tw_w.dws_token_info_mf(
cal_month, role_id, 
