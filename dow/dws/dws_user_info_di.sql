...
is_paid, pay_count, money_ac, moneyrmb_ac, 
...
select 
a.role_id, b.device_id, b.open_id, b.adid, 
-- coalesce(b.zone_id, 'unknow') as zone_id,  
-- coalesce(b.alliance_id, 'unknow') as alliance_id,  
-- coalesce(b.os, 'unknow') as os,  
-- coalesce(b.channel, 'unknow') as channel, 
b.zone_id, b.alliance_id, b.os, b.channel, 
b.ip, b.country, 
b.network, b.campaign, b.creative, b.adgroup, 
b.campaign_id, b.creative_id, b.adgroup_id, 
null as adtag, 
null as adcost, 
a.is_test, 
a.install_ts, 
...
a.pay_count, a.money_ac, a.moneyrmb_ac, 
