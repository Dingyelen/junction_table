###
create table if not exists hive.dow_jpnew_w.dws_item_snapshot_di(
date date, 
role_id varchar, 
...
delete from hive.dow_jpnew_w.dws_item_snapshot_di
where part_date >= $start_date
and part_date <= $end_date;

insert into hive.dow_jpnew_w.dws_item_snapshot_di(
...
from hive.dow_jpnew_r.dwd_merge_item_live
where part_date >= $start_date
and part_date <= $end_date
), 
