###
create table if not exists hive.mushroom_tw_w.ads_core_costreason_di
(date date,
zone_id varchar,
channel varchar,
reason varchar,
...
delete from hive.mushroom_tw_w.ads_core_costreason_di
where part_date >= $start_date
and part_date <= $end_date;

insert into hive.mushroom_tw_w.ads_core_costreason_di
