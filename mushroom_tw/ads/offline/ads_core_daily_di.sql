create table if not exists hive.dow_jpnew_w.ads_core_daily_di
(date date,
zone_id varchar,
channel varchar,
core_add bigint,
...
delete from hive.dow_jpnew_w.ads_core_daily_di
where part_date >= $start_date
and part_date <= $end_date;

insert into hive.dow_jpnew_w.ads_core_daily_di
